    ...
    return (
        <div className="animate-fade-in">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
                <div>
                    <h2 className="text-3xl font-black text-white tracking-tight">Pulse <span className="text-primary-500">Logs</span></h2>
                    <p className="text-slate-500 mt-1">Real-time attendance tracking and session activity.</p>
                </div>
            ...
            <div className="glass-card rounded-[2rem] overflow-hidden">
                <div className="p-6 border-b border-white/5 flex flex-col md:flex-row justify-between items-center bg-white/[0.02] gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-lg font-bold text-white">Daily Logs</h3>
                    </div>
                </div>
                                ...
                                <tr key={log._id} className="text-slate-300 hover:bg-white/[0.03] transition-colors group">
                                    <td className="px-8 py-5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="font-bold text-white uppercase tracking-tight">{log.employeeId?.name}</span>
                                        </div>
                                    </td>
                                    <td className="px-8 py-5 font-medium text-slate-500">{new Date(log.date).toLocaleDateString()}</td>
                                    <td className="px-8 py-5">
